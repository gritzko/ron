...
syn match UUID_ATOM />\s*[`]\{0,1}\([0-9A-Za-z_~]\/\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}\([-+$%]\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}/
hi UUID_ATOM ctermfg=DarkGreen
syn match FLOAT_ATOM /\^\s*[+-]\{0,1}[0-9]\{0,19}[.][0-9]\{1,19}\([Ee][+-]\{0,1}[0-9]\{1,3}\)\{0,1}/
hi FLOAT_ATOM ctermfg=Green
syn match OBJECT_ID /#\s*[`]\{0,1}\([0-9A-Za-z_~]\/\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}\([-+$%]\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}/
hi OBJECT_ID ctermfg=Blue
syn match TYPE_ID /*\s*[`]\{0,1}\([0-9A-Za-z_~]\/\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}\([-+$%]\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}/
hi TYPE_ID ctermfg=DarkMagenta
syn match EVENT_ID /@\s*[`]\{0,1}\([0-9A-Za-z_~]\/\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}\([-+$%]\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}/
hi EVENT_ID ctermfg=DarkBlue
syn match REF_ID /:\s*[`]\{0,1}\([0-9A-Za-z_~]\/\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}\([-+$%]\)\{0,1}\(\([(\[{}\])]\)\{0,1}[0-9A-Za-z_~]\{0,10}\)\{0,1}/
